...
searchInput.addEventListener('input', () => {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        const leftButton = document.querySelector('.boton-izquierda');
        const rightButton = document.querySelector('.boton-derecha');
        const carouselTrack = document.querySelector('.carousel-tracks');
    
        let scrollAmount = 0;
    
        // Definir cuánto se desplazará cada vez que se presione el botón
        const scrollDistance = 320; // Ajusta este valor según tus necesidades
